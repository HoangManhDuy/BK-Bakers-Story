...
@section('content')
        ...
        <div class="container">
            ...
            <div class="pull-right">
                <div class="beta-breadcrumb">
                    <a href="{{ route('home') }}">Home</a> / <span>Đặt hàng</span>
                </div>
            </div>
    ...
    <div class="container">
        <div id="content">
            <form action="{{ route('postOrder') }}" method="post" class="beta-form-checkout">
                                ...
                                <ul class="payment_methods methods">
                                    ...
                                    <li class="payment_method_cheque">
                                        ...
                                        <div class="payment_box payment_method_cheque" style="display: none;">
                                            ...
                                            <br>- Chủ TK: Hoàng Mạnh Duy
                                            <br>- Ngân hàng ACB, Chi nhánh Hai Bà Trưng
                                        </div>
                                    </li>
                                </ul>
                            </div>
