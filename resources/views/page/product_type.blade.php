                                        ...
                                        @endif
                                            <div class="single-item-header">
                                                <a href="{{ route('product.detail', $sp->id) }}">
                                                    <img src="/source/image/product/{!! $sp->image !!}" alt="" height="250 px">
                                                </a>
                                            </div>
                                ...
                                @foreach($sp_khac as $khac)
                                    <div class="col-sm-4">
                                        ...
                                        <div class="single-item">
                                            ...
                                            @endif
                                            <div class="single-item-header">
                                                <a href="{{ route('product.detail', $khac->id) }}">
                                                    <img src="/source/image/product/{!! $khac->image !!}" alt="" height="250 px">
                                                </a>
                                            </div>
                                            <div class="single-item-body">
                                                ...
                                                <p class="single-item-price" style="font-size: 18px">
                                                    @if($khac->promotion_price == 0)
                                                        <span>
                                                                {!! number_format($khac->unit_price) !!} đồng
                                                        </span>
                                                    @else
                                                        <span class="flash-del">
                                                                {!! number_format($khac->unit_price) !!} đồng
                                                        ...
                                                        <span class="flash-sale">
                                                                {!! number_format($khac->promotion_price) !!} đồng
                                                        </span>
                                                    @endif
                                                </p>
                                            </div>
